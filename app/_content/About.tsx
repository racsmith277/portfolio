    ...
    <div className="md:flex md:min-h-screen md:flex-col">
      ...
      <div className="flex w-full flex-1 flex-col items-center justify-center">
        <div className="flex flex-col gap-3 p-4 pb-16 md:max-w-lg md:pb-4">
          <p className="text-sm">
            {`I graduated from `}
            <span className="text-rose-300 font-semibold">Harvard</span>
          ...
          <p className="text-sm">
            ...
            <span className='text-orange-300 font-semibold'>Voicebar</span>
            {`, in 2021. I’ve been the co-founder and CTO of two venture-backed companies that have raised over $2M in funding. `}
          </p>
