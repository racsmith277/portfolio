...
const GithubIcon = ({ size = DEFAULT_SIZE }) => {
  return (
    <svg
      width={size}
      height={size}
...
const LinkedInIcon = ({ size = DEFAULT_SIZE }) => {
  return (
    <svg
      width={size}
      height={size}
...
const TwitterIcon = ({ size = DEFAULT_SIZE }) => {
  return (
    <svg
      width={size}
      height={size}
...
const ChevronRightIcon = ({ size = DEFAULT_SIZE }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
const ArrowLeftIcon = ({ size = DEFAULT_SIZE, color = "currentColor" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
const ExternalLinkIcon = ({ size = DEFAULT_SIZE, color = "currentColor" }) => {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
